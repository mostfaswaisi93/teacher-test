...
@section('title') @lang('admin.create_unit') @endsection
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">@lang('admin.create_unit')</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">@lang('admin.create_unit')</li>
                    </ol>
                </div>
            </div>
        </div>
