...
class ParentController extends Controller
{
            ...
            return datatables()->of($parents)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_parents')) {
                        $button = '<a type="button" title="Edit" name="edit" href="parents/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
                        $button = '<a type="button" title="Edit" name="edit" id="' . $data->id . '" class="edit btn btn-sm btn-icon disabled"><i class="fa fa-edit"></i></a>';
                    }
                    $button .= '&nbsp;&nbsp;';
                    if (auth()->user()->hasPermission('delete_parents')) {
    ...
    {
        return view('admin.parents.edit')->with('facility', $facility);
    }
