...
class RateController extends Controller
{
            ...
            return datatables()->of($rates)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_rates')) {
                        $button = '<a type="button" title="Edit" name="edit" href="rates/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
    ...
    {
        return view('admin.rates.edit')->with('facility', $facility);
    }
