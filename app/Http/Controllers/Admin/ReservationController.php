...
class ReservationController extends Controller
{
        ...
        if (request()->ajax()) {
            return datatables()->of($reservations)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_reservations')) {
                        $button = '<a type="button" title="Edit" name="edit" href="reservations/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
    ...
    {
        return view('admin.reservations.edit')->with('facility', $facility);
    }
