...
class DiscountController extends Controller
{
        ...
        if (request()->ajax()) {
            return datatables()->of($discounts)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_discounts')) {
                        $button = '<a type="button" title="Edit" name="edit" href="discounts/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
                        $button = '<a type="button" title="Edit" name="edit" id="' . $data->id . '" class="edit btn btn-sm btn-icon disabled"><i class="fa fa-edit"></i></a>';
                    }
                    $button .= '&nbsp;&nbsp;';
                    if (auth()->user()->hasPermission('delete_discounts')) {
    ...
    {
        return view('admin.discounts.edit')->with('facility', $facility);
    }
