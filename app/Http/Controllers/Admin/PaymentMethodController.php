...
class PaymentMethodController extends Controller
{
            ...
            return datatables()->of($payment_methods)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_payment_methods')) {
                        $button = '<a type="button" title="Edit" name="edit" href="payment_methods/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
    ...
    {
        return view('admin.payment_methods.edit')->with('facility', $facility);
    }
