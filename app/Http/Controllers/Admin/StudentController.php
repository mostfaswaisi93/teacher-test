...
class StudentController extends Controller
{
            ...
            return datatables()->of($students)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_students')) {
                        $button = '<a type="button" title="Edit" name="edit" href="students/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
    ...
    {
        return view('admin.students.edit')->with('facility', $facility);
    }
