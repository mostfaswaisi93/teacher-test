...
class NotificationController extends Controller
{
        ...
        if (request()->ajax()) {
            return datatables()->of($notifications)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_notifications')) {
                        $button = '<a type="button" title="Edit" name="edit" href="notifications/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
    ...
    {
        return view('admin.notifications.edit')->with('facility', $facility);
    }
