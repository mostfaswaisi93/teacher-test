...
class SubjectController extends Controller
{
            ...
            return datatables()->of($subjects)
                ->addColumn('action', function ($data) {
                    if (auth()->user()->hasPermission('update_subjects')) {
                        $button = '<a type="button" title="Edit" name="edit" href="subjects/' . $data->id . '/edit" class="edit btn btn-sm btn-icon"><i class="fa fa-edit"></i></a>';
                    } else {
    ...
    {
        return view('admin.subjects.edit')->with('facility', $facility);
    }
